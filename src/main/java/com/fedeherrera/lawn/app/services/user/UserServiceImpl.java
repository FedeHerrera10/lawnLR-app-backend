...
import com.fedeherrera.lawn.app.dtos.request.DTOResetPassword;
...
import com.fedeherrera.lawn.app.repositories.ConfirmationTokenRepository;
...
import com.fedeherrera.lawn.app.services.googleAuth.GoogleTokenVerifier;
import com.fedeherrera.lawn.app.services.mail.EmailService;
import com.fedeherrera.lawn.app.utils.MapperUtil;
...
import static com.fedeherrera.lawn.app.services.user.MessageUserService.*;
...
public class UserServiceImpl implements UserService {
    ...
    public DTOUserResponse updateUser(Long id, DTOUserUpdate dtoUserUpdate) {
        ...
        user.setDocument(dtoUserUpdate.getDocument());
        user.setBirthdate(dtoUserUpdate.getBirthdate());
        user.setNumberPhone(dtoUserUpdate.getNumberPhone());
